  ...
  <div ng-show="wallet!=null" ng-controller='exchangeCtrl'>
    ...
    @@if (currency_selection !== 'CM' ) { 
              <div  class="col-md-12">
                ...
                <div class="balance-amount text-primary">{{balanceEL| number : 2}} {{ 'CUR' | translate }}</div>
              </div> 
    }
    @@if (currency_selection !== 'N' ) {  
              <div  class="col-md-12">  
                    <div class="balance-item">{{ 'CUR_credit_mut' | translate }}</div>
                    <div class="balance-amount text-primary">{{balanceCM| number : 2}} {{ 'CUR' | translate }}</div>
              </div>
    } 
             </div> 
    ...
    @@if (currency_selection !== 'N' ) {       
              ...
              <div   ng-hide="acc_type_obj.is_admin">    
                <div class="col-md-12">             
             ...
             <div  class="col-md-12 ">  
                    ...
                    <span class="text-primary">{{limitCMp}} {{ 'CUR' | translate }}</span> 
             </div> 
             <div  class="col-md-12  ">  
                    <span class="balance-item">{{ 'LIM_debit' | translate }}</span>
                    <span class="text-primary">{{limitCMm}} {{ 'CUR' | translate }}</span>
             </div>
   ...
   @@if (currency_selection !== 'CM' ) { 
            ...
            <div class="row grp"  ng-hide="acc_type_obj.is_admin"> 
                <div class="col-md-12 ">
                   <label translate="EXC_Credit_1" >Credit</label><label translate="CUR_nanti" >Curr </label>   <label translate="EXC_Credit_2" >on account Account :</label>  
               </div>
               ...
               <div class="col-md-col-md-9 col-xs-9 ">
                  <span class="balance-item"  translate="EXC_Credit_prefix" ></span>  <span class="text-primary"> <input type="number" step="0.01" placeholder="0.00" ng-model="credit_amount" ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" style="max-width:200px;display: inline-block;"/></span>
                   <span  class="text-primary" translate="CUR" ></span>
               </div> 
   ...
   @@if (currency_selection !== 'N' ) {   
                           <p ng-hide="acc_type_obj.is_admin">
                               <label translate="LIM_limites" >Vos limites de </label>&nbsp;<label translate="CUR_credit_mut" > CM</label><label>:</label>    
                           </p>                       
                           <p ng-hide="acc_type_obj.is_admin">
                            <span class="balance-item">{{ 'LIM_credit' | translate }}</span>   
                    <span class="text-primary"> <input type="text" id="limitP" min="0" ng-model="pop_limitCMp" ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" value="{{pop_limitCMp}}"/> {{ 'CUR' | translate }}</span>    
                          </p> 
                            
                           <p ng-hide="acc_type_obj.is_admin">
      
                    <span class="balance-item">{{ 'LIM_debit' | translate }}</span>
                    <span class="text-primary"><input type="text" id="limitM" max="0" ng-model="pop_limitCMm"  ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" value="{{pop_limitCMm}}"/>  {{ 'CUR' | translate }}</span>
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <h4 align="center">
                           ...
                           <p> <span translate="EXC_CreditAmount" ></span> <span class="text-primary"> {{credit_amount}}  <span translate="CUR"> </span></span>   </p>
